...
_FREQUENCIES: Final[dict[CryptoFamily, tuple[str, ...]]] = {
    ...
    "market_membership": ("catalog_snapshot",),
    "instrument_catalog": ("catalog_snapshot",),
    "derivative_bars": ("1d", "1h", "5m", "1m"),
    "derivative_trades": ("recent_trade_snapshot",),
    "derivative_book_snapshots": ("point_in_time_book",),
    ...
    "onchain_catalog": ("catalog_snapshot",),
    "onchain_metrics": ("1d",),
...
_LIMITS: Final[dict[CryptoFamily, tuple[str, ...]]] = {
    ...
    "market_membership": ("active_spot_and_perpetuals", "three_exact_venue_catalogs"),
    ...
    "onchain_catalog": ("reviewed_metrics_only", "page_max_1000_cursor_max_100_pages"),
    "onchain_metrics": ("exact_qualified_catalog_membership_only", "page_max_10000"),
