# Vendored from https://github.com/shiyu-coder/Kronos
# Commit: 67b630e67f6a18c9e9be918d9b4337c960db1e9a  (MIT License — see LICENSE in this directory)
# Local edits: removed the sys.path hack; rewrote `from model.module import *` to the
# package-relative import. No other changes.
# Excluded from ruff/mypy (see root pyproject.toml); refresh by re-fetching at a new pinned
# commit and re-applying the edits above.
...
from alpha_forecast._vendor.kronos.module import *  # noqa: F403
