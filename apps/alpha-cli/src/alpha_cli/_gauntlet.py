...
def _metadata(
    ...
    return RunMetadata(
        ...
        threshold=params.threshold,
        confidence=params.confidence,
        dsr_threshold=params.dsr_threshold,
        cpcv_groups=params.cpcv_groups,
        cpcv_test_groups=params.cpcv_test_groups,
        tier1_divergence_tol=params.tier1_divergence_tol,
    )
