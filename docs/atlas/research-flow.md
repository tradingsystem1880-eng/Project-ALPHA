...
|---|---|---|---|
| Idea Capture | `apps/alpha-cli/src/alpha_cli/research_cmds.py:840` | tested | Preserve a raw market observation verbatim and open a governed Research Case before any strategy code exists. Capture is idempotent and grants no runner, strategy, holdout, paper, or execution authority. |
