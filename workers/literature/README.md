...
The one research network surface (ADR-0024): an isolated, stdlib-only worker that looks up
...
`SourceReceipt` labelled `UNTRUSTED_SOURCE`; document text never carries instruction authority.
