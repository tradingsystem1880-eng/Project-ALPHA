...
- For Project ALPHA security and performance review requirements, follow the authoritative root
  `CLAUDE.md`; do not import generic checklists over project-specific fail-loud and credential
  boundaries.
